package br.edu.ifpb.firecorp.rest.exceptionhandler;
...
import br.edu.ifpb.firecorp.domain.exception.EntidadeNaoEncontradaException;
import br.edu.ifpb.firecorp.domain.exception.RegraNegocioException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
		List<Erro> erros = Arrays.asList(Erro.builder().descricao(ex.getMessage()).build());
